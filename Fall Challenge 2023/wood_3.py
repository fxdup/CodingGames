...
Wood 3
Startegy:
1. Go to closest fish
2. Open lights only if the fish is close enough to be scanned (Distance < 2000u)
"""
    ...
    for drone in my_drones:
        ...
        for fish in visible_fish:
            if fish.fish_id not in my_scans:
                distance = distance_between(drone.pos,fish.pos)
        ...
        if target is None:
            ...
            light = 1 if closest < 2000 else 0
